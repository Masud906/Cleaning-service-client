...
const Footer = () => {
  return (
    <div className="mt-10">
      ...
      <footer className="footer px-10 py-4 border-t bg-green-300 text-base-content border-base-300">
        <aside className="items-center grid-flow-col">
          ...
          <p>MASUD Industries Ltd. <br />Providing reliable tech since 2024</p>
        </aside>
